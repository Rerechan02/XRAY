...
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "  ${RB}FN${NC} ${YB}XRAY Websocket${NC}          ${WB}|${NC}  ${YB}- Websocket (CDN) TLS${NC}"
echo -e "  ${RB}FN${NC} ${YB}TROJAN Websocket${NC}        ${WB}|${NC}  ${YB}- Websocket (CDN) NTLS${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
...
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "              ${WB}»»» Path All Service «««${NC}             "
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "  ${RB}FN${NC} ${YB}Trojan               : /funy /funny${NC}"
echo -e "  ${RB}FN${NC} ${YB}Vmess                : /worryfree /rerechan02${NC}"
echo -e "  ${RB}FN${NC} ${YB}Vless                : /whatever /vless-tls${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo ""